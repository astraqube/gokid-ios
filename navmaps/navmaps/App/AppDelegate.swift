...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        vc.metadata = MapMetadata(name: "Soccer", thumbnailImage: UIImage(named: "test_userImage"), dateString: "Wed July 20, 2015", shortDateString: "July 20", canNavigate: true, id: 0, type: .Dropoff)
        return true
    }
